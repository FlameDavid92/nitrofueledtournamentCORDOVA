                    ...
                    <form onSubmit={inizializzaTorneo}>
                        <div className="form-row text-center">
                            <div className="form-group col-12">
                                ...
                                <input ref={input => loadFile = input} onChange={caricaTorneoDaFile} className="btn btn-secondary mt-2 ml-2" type="file" id="carica-torneo" accept=".txt"></input>
                                {window.cordova && <input ref={input => loadFileName = input} name="loadFileName" className="form-control form-control-sm mb-2 mt-4" type="text" placeholder="Inserisci il nome del torneo da caricare" required></input>}
