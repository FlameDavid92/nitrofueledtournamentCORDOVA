...
export default function MyModal2({ pointsChanged, setPointsChanged, clicksModal2, title, players, setPlayers, myTournament, setMyTournament, pointsChangeId}) {
    ...
    const cambiaPunti = (e) => {
        ...
        setPointsChanged(pointsChanged + 1);
