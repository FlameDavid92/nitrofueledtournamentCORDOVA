                    ...
                    <form onSubmit={inizializzaTorneo}>
                        <div className="form-row text-center">
                            <div className="form-group col-12">
                                ...
                                {window.cordova && <input name="loadFileName" className="form-control form-control-sm mb-2 mt-2" type="text" placeholder="Inserisci il nome del torneo da caricare" required></input>}
