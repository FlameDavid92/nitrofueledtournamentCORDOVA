...
export default function MyTournament({writeFile, goToHome, setAudio, setInitForm, setInitForm2, setTournamentName, setNumGioc, setTipo, setPlayers, tournamentName, load, tipo, numGioc, battles, tracks, players }) {
    ...
    return (
        <>
            ...
            <MyModal2 setPointsChanged={setPointsChanged} title="Modifica Punti" myTournament={myTournament ? myTournament : []} setMyTournament={setMyTournament} pointsChangeId={pointsChangeId} players={players} setPlayers={setPlayers} clicksModal2={clicksModal2}></MyModal2>
        </>
    )
}